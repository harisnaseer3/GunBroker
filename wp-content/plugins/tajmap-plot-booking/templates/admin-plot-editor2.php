...
<div class="wrap tajmap-plot-editor">
    <div class="editor-header">
        ...
        <div class="editor-actions">
            ...
            <button class="btn info" onclick="window.location.href='<?php echo admin_url('admin.php?page=tajmap-plot-viewer'); ?>'">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="tool-palette">
            <div class="palette-section">
                ...
                <div class="tool-group">
                    ...
                    <button class="tool-btn" id="rotate-tool" data-tool="rotate">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <button class="tool-btn" id="duplicate-selected-tool" data-tool="duplicate-selected">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
